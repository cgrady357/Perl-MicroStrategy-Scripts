...
is($foo->remove_attribute_form(	ATTRIBUTEFORM => "form_name", 
				ATTRIBUTE => "attribute_name", 
				LOCATION => "location_path", 
				PROJECT => "project_name"
			   ),
...
is($foo->remove_folder_ace(	FOLDER => "folder_name", 
				LOCATION => "location_path", 
				USER_OR_GROUP => "USER", 
				USER_LOGIN_OR_GROUP_NAME => "user_login_or_group_name", 
				PROJECT => "project_name"
...
is($foo->remove_project_ace(	PROJECT_OBJECT_TYPE => "project_object_type", 
				OBJECT_NAME => "object_name", 
				LOCATION => "location_path", 
				USER_OR_GROUP => "GROUP", 
				USER_LOGIN_OR_GROUP_NAME => "user_login_or_group_name",
...
is($foo->remove_server_cluster("server_name"), 'REMOVE SERVER "server_name" FROM CLUSTER;', "remove_server_cluster");

is($foo->remove_user(	USER => "login_name", 
