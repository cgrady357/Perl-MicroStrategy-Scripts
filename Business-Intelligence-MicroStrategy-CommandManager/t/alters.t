...
is(
$foo->alter_project_config(	DESCRIPTION => "MicroStrategy Tutorial Project", 
				...
				PROJDRILLMAP => '\Public Objects\Drill Maps\MicroStrategy Tutorial Drill Map',
				DRILLMAP_LOCATION => '\Public Objects\Drill Maps\MicroStrategy Tutorial Drill Map', 
...
is(
   $foo->alter_report(	REPORT => "Profit Forecast", 
			LOCATION => '\Public Objects\Reports\Subject Areas\Enterprise Performance Management', 
			ENABLECACHE => "DEFAULT",
			...
			NEW_LOCATION => '\Public Objects\Reports\Subject Areas\Enterprise Performance Management\Profit', 
			HIDDEN => "FALSE",
			PROJECT => "MT"
		  ),
...
is(
$foo->alter_report_caching(	PROJECT => "MT", 
                           	ENABLED => "ENABLED",  
...
is(
    $foo->alter_security_filter(SECURITY_FILTER => "SecFilter3", 
			     	LOCATION => '\Public Objects\Filters', 
				HIDDEN => "FALSE",
				PROJECT => "MicroStrategy Tutorial", 
...
is($foo->alter_security_role(	SECURITY_ROLE => "FIS Power Users", 
...
$foo->alter_server_config(	DESCRIPTION => "Test description", 
...
is(
    $foo->alter_shortcut(	LOCATION => '\Public Objects',
...
is(
   $foo->alter_user_group(	USER_GROUP => "UAT Users", 
...
is(
    $foo->alter_users(	USER_GROUP => "Managers", 
			PASSWORD => "test", 
			CHANGEPWD => "TRUE",
